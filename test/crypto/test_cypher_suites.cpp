...
BOOST_AUTO_TEST_CASE(test_k1) try {
   auto private_key_string = std::string("5JWrdLWd77qGgCpR1fJeECxEJ64U7UzZ9YquVNjK11S9DH234f4");
   auto expected_public_key = std::string("RSN8QhCycJ61sq6rbBKN1cSSU1csHPDmGwCGZMtNUfHJqQ9mUWrZU");
