...
BOOST_AUTO_TEST_CASE(test_k1) try {
   auto private_key_string = std::string("5KKES2ZPo3H8PjAmwDXrvmE56qtwGAVhvS7gRYQPRDfHFurvEpy");
   auto expected_public_key = std::string("RSN7yTxtZr3EKN4S8pE1rrRHjYzXN3SnZCzq77zj4dzwFcrJC97jp");
